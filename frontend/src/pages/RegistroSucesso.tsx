...
export default function RegistroSucesso() {
  ...
  useEffect(() => {
    ...
    // Salva a carteira NEAR no localStorage (se ainda não estiver salva) e loga no console
  ...
  const handleSalvarCarteiras = async () => {
    ...
    try {
      ...
      setSaved(true);
      setTimeout(() => {
        // Redireciona para o feed conforme o perfil selecionado
